...
public class MyDemoLoggingAspect {
	...
	@Around("execution(* com.mohit.aopdemo.service.*.getFortunes(..))")
...
//			
//			// give a default fortune
//			result = "Major Accident!! But Help Helicopter is on the way!!";
//		}
				
		// ===== RETHROW THE EXCEPTION EXAMPLE -- ABOVE IS SHOWING HANDLING EXCEPTION
		Object result;
		try {
			result = proceedingJoinPoint.proceed();
		} catch (Throwable e) {
